...
return new class extends Migration
{
    ...
    {
        // Drop FK by actual name if it exists
        $this->dropForeignKeyIfExists('products', 'category_id');

        // Keep column nullable to avoid violating existing NULL data on rollback
        // If you must enforce NOT NULL, ensure data is backfilled before this point.

        Schema::table('products', function (Blueprint $table) {
            // Recreate FK with restrictive behavior
